...
$resultado = mysqli_query($conexion, $peticion);
   ...
   $resultado = mysqli_query($conexion, $peticion);
    ...
    $peticion = "INSERT INTO lineaspedido VALUES (null,'".$_SESSION
    ['idpedido']."','".$_SESSION['producto'][$i]."','".$_SESSION
    ['cantidad'][$i]."')";
$resultado = mysqli_query($conexion, $peticion);
...
echo '
  <meta http-equiv="refresh" content="5; url=../index.php">
   ';
        ...
        echo "El usuario no existe. Volviendo ala tienda en 5 segundos...";
        echo '
